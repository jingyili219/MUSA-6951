...
plot=pt+theme_AZpop()
print(plot)
ggsave("Least Populated AZ Counties.jpeg",width=12,height=8)
```
...
pt <- ggplot() +
  ...
  labs(title = "School Types in Philadelphia",caption = "Data source: OpenDataPhilly.com") +
...
print(plot2)
ggsave("School Types in Philadelphia.jpeg",width=12,height=8)
```
...
print(plot3)
ggsave("Historic Average Temperature in Tucson.jpeg",width=12,height=8)
```
